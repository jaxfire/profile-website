...
<html lang="en">
    <head>
        ...
        <meta name="description" content="James Ash - Software Developer">
        ...
        <title>James Ash - Software Developer</title>
        ...
        <!-- Original link with W3C error for color attribut    -    <link rel="mask-icon" href="/resources/favicons/safari-pinned-tab.svg" color="#5bbad5"> -->
        <link rel="mask-icon" href="/resources/favicons/safari-pinned-tab.svg"><!-- With color attribute removed -->
    ...
    <body>
        <header>
            ...
            <div class="hero-text-box">
                <h1>HELLO WORLD!<br /> JAMES ASH: SOFTWARE DEVELOPER</h1>
                <a href="#" class="btn btn-full js--scroll-to-plan">Projects</a>
                <a href="#" class="btn btn-ghost js--scroll-to-start">Get in touch</a>
            </div>        
        </header>
